...
The Multi Team Delivery Forecaster template for Jira & Azure DevOps (ADO) is provided **free of charge** as an open-source resource to help teams visualize their delivery forecasts for multiple teams. 
This template is a **static configuration file** and does **not** interact with user data, Jira/ADO instances, or external systems.
...
- If using this template in a shared or corporate Jira/ADO environment, ensure compliance with internal data policies.
...
For any privacy-related inquiries, please open an issue in the repository: [GitHub Issues](https://github.com/nbrown02/Multi-Team-Forecaster/issues).
